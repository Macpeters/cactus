    ...
    <div class="batch-logs">
      <div class="row">
        <article class="batch">
          ...
          <img v-bind:src="batch_02_seedlings_02" alt="Trichocereus peruvianus seedlings from 2019/07/23" />
          <img v-bind:src="batch_02_seedlings" alt="Trichocereus peruvianus seedlings from 2019/04/18" />
        </article>
