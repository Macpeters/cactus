  ...
  <div>
    ...
    <div class="batch-logs">
      <div class="row">
        <article class="batch">
          <section>
            <h1>Batch 3: v caespitosa</h1>
            <h2>Plants</h2>
            <h3>05/2019 - 52 Remaining</h3>
            <div>
              <p>
          ...
          <img v-bind:src="batch_03_plants_02" alt="Lopophora williamsii seedlings from 2021/09/12" />
          <img v-bind:src="batch_03_plants_01" alt="Lopophora williamsii seedlings from 2020/08/21" />

          <section>
            <h2>Seedlings</h2>
            <h3>03/2020 - 69 remaining</h3>
            <div>
              <p>
                These guys benefited from lessons I learned in previous batches - they got a longer incubation,
                and it shows.  They've largely settled into the plump globular shape that I'd expect from adults.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div>
              <p>
                I sowed 100 seeds in 3 X 2 inch plastic pots in a plastic bin with lid.  It looked like about 64
                germinated to begin with, but it was hard to get an exact count because of the way they werre scattered,
                and it looked like a few more were trying to put down roots.
              </p>
            </div>
          </section>
        ...
        <article class="batch">
          <section>
            <h1>Batch 2: v caespitosa</h1>
            <h2>Plants</h2>
            <h3>03/2018 - 5/6 Remain</h3>
            <div>
              <p>
                These have largely matured.  They grow slowly, but they have the proper shape of the species, and
              they're showing the tiny tufts of hair common to the species.  One seems to have burst - probably
              from too much water outside.  It isn't quite dead, so I'm leaving it to see if it survives and heals.
              </p>
            </div>
          </section>
          <img v-bind:src="batch_02_plants_02" alt="Lopophora williamsii seedlings from 2021/09/12" />
          <img v-bind:src="batch_02_plants_01" alt="Lopophora williamsii seedlings from 2020/08/21" />

          <section>
            <h2>Seedlings</h2>
            <h3>03/20 - 9 remaining</h3>
            <div>
              <p>
                I have had better luck keeping tiny pots in a clear tupperware container for a longer
                incubation period.  I'll do that from now on and probably do a lot better.
              </p>
            </div>
          </section>
      ...
      <div class="row">
        <article class="batch">
          <section>
            <h1>Charlie: v menchaka</h1>
            <h2>Born November 6, 2014</h2>
            <div>
              <p>
                ...
                he's starting to show fresh bulges of growth on top, so I'm excited to see how those play out.  It's interesting
                how the plant grows new nodes in the center, and those grow, and splay out while the old ones fall
                over the side, sag, collaps, and eventually cork.
              </p>
            </div>
          </section>
          <img v-bind:src="charlie_05"  alt="Lopophora williamsii late Summer, 2021" />
        ...
        <article class="batch">
          <section>
            <h1>Batch 1: v caespitosa</h1>
            <h2>Plants</h2>
            <h2>09/2021 - 1 Remains</h2>
            <div>
              <p>
                Only 1 left from this sad batch, but he's doing fine.  There's some algae on top of
                the pot, as it's been sittin outside getting rained on.  I'll let it dry out well before
                watering again, and it should die off.
              </p>
            </div>
          </section>
          <img v-bind:src="batch_01_plants_02" alt="Lopophora williamsii from 2021/09/12" />
          <img v-bind:src="batch_01_plants_01" alt="Lopophora williamsii from 2020/08/21" />

          <section>
            <h2>Seedlings</h2>
            <h3>09/2018 - 2 Remain</h3>
            <div>
              <p>
                ...
                There were some redish tinges for a little while, and I experimented with moving the seedlings further from the light,
...
<script>
  ...
  import charlie_05 from '../../assets/cacti/lopophoraWilliamsii/charlie_05.jpg';
  ...
  import batch_01_plants_02 from '../../assets/cacti/lopophoraWilliamsii/batch_01_plants_02.jpg';
  ...
  import batch_02_plants_02 from '../../assets/cacti/lopophoraWilliamsii/batch_02_plants_02.jpg';
  ...
  import batch_03_plants_02 from '../../assets/cacti/lopophoraWilliamsii/batch_03_plants_02.jpg';

  export default {
    head () {
      return {
        name: 'lopophoraWilliamsii',
        title: 'Lopophora williamsii',
        meta: [
