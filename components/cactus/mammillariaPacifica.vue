    ...
    <div class="batch-logs">
      <div class="row">
        <article>
          ...
          <img v-bind:src="batch_01_seedlings_02" alt="Mammillaria pacifica seedlings from 2019/07/23"  />
          <img v-bind:src="batch_01_seedlings" alt="Mammillaria pacifica seedlings from 2019/04/18"  />
        </article>
      </div>
    </div>
  </div>
